            ...
            tabItems(
                tabItem(
                    ...
                    tags$ol(
                        ...
                        tags$li("Click on the target to place points. You will need to put at least 10 points."),
                        tags$li("Examine and use the provided feedback to place points until you meet the challenge."),
                        tags$li("When you achieve the current challenge, press the Next button to try another. 
                                (Note: there are only four unique challenges.")),
                    div(
                    ...
                    p("This app was developed and coded by Yuxin Zhang and 
                      updated by Luxin Wang, Thomas McIntyre and Chenese Gray."),
                ...
                tabItem(
                    ...
                    tags$ul(
                        tags$li("Measurement is one of the main components of Statistics. 
                                ...
                                a person's height), or a collection through the use of a statistic 
                        ...
                        tags$li(strong('Reliability'), "refers to how consistent the measurement process 
                                is. If you carry out the process in the exact same way on the 
                                exact same object and then compare all of your measurements, 
                                are they all the same (no variation), fairly close to each 
                                each other (low variation), or really far from each other 
                ...
                tabItem(
                    ...
                    p(
                      class = "hangingindent",
                      "Jeroen Ooms (2020). V8: Embedded JavaScript and WebAssembly 
